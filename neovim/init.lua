...
require('lazy').setup({
...

  {
    ...
    'hrsh7th/nvim-cmp',
    dependencies = {
      -- Expand language-server completions that contain snippet placeholders
      'L3MON4D3/LuaSnip',
...

  {
    ...
    config = function()
      ...
      --           use `saiw(` so the surrounding is padded, `saiw)` is unpadded
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'vimdoc', 'vim', 'jinja', 'ocaml' },
...
local servers = {
  ...
  -- sometimes there is no prebuilt clangd for linux_arm64, here is a workaround:

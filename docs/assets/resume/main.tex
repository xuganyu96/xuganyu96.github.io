...
\begin{document}
    ...
    \section{Technical skills}
        ...
        \vspace{0.2 cm}
        \begin{onecolentry}
            \textbf{Cryptography \& network security:} post-quantum cryptography, finite-field arithmetic, TLS
            % \textbf{Cryptography \& network security:} TLS, ECC, RSA, DSA, Diffie-Hellman key exchange, OpenSSL
        \end{onecolentry}
        \vspace{0.2 cm}
        \begin{onecolentry}

...
\begin{document}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Resolved data storage scalability and optimized for analytical queries by migrating from PostgreSQL to AWS S3 for storage and AWS Athena for query engine
    ...
    \section{Projects}
        \begin{onecolentry}
            \href{https://github.com/RustCrypto}{\textbf{RustCrypto}}
        \end{onecolentry}
        \vspace{0.1cm}
        \begin{onecolentry}
        ...
        \begin{onecolentry}
            \href{https://github.com/rustls/rustls}{\textbf{rustls}}
        \end{onecolentry}
        \vspace{0.1cm}
        \begin{onecolentry}
            \begin{highlights}
               \item \href{https://github.com/rustls/rustls/pull/1328}{Identified incorrect TLS termination at google.com and fixed the example binaries to connect to other properly working TLS server} 
            \end{highlights}
        \end{onecolentry}
        \vspace{0.2cm}
        ...
        \begin{onecolentry}
            \href{https://github.com/aelzeiny/airflow-aws-executors/tree/master}{\textbf{Airflow Fargate Executor}}
        \end{onecolentry}
        \vspace{0.1cm}
        \begin{onecolentry}
            \begin{highlights}
                \item An alternative task executor that launches AWS Fargate container per Airflow task instance instead of keeping long-running workers. Fargate executor saves users from paying for idling worker instances on AWS while also increasing the cluster's parallel execution capacity
            \end{highlights}
        \end{onecolentry}
